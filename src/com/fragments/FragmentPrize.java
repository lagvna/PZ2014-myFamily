...
/**
 * Fragment przypiety do aktywnosci zwiazanej z nagrodami za zadania. Wyswietla
 * nagrody uzytkownikow.
 * 
 * @autho kwachu
 * 
 */
public class FragmentPrize extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.fragment_prize, container,
				false);
		/*
		 * context = getActivity().getApplicationContext(); Button
		 * addPrizeButton = (Button) rootView.findViewById(R.id.addPrizeButton);
		 * addPrizeButton.setOnClickListener(new OnClickListener() {
		 * 
		 * @Override public void onClick(View v) { addPrizePopUp(); } });
		 */

		prizesListView = (ListView) rootView
				.findViewById(R.id.oldTasksListView);
	...
	/**
	 * Metoda aktualizujaca liste nagrod.
	 * 
	 * @param allPrizes
	 *            zaktualizowana lista nagrod
	 */
