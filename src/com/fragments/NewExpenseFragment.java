    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        accept.setOnClickListener(new OnClickListener()	{
			...
			public void onClick(View arg0) {
				if(!title.getText().toString().equals("") && !expense.getText().toString().equals(""))	{
					...
					sendToServer(); // tu bedzie jakas komunikacja z serwerem, zeby wyslac dane
					
					
					Toast.makeText(getActivity(), "Dodano nowy wydatek", Toast.LENGTH_SHORT).show();
		    	} else	{
		    		Toast.makeText(getActivity(), "Wprowadź tytuł i/lub kwotę", Toast.LENGTH_SHORT).show();
		    	}
			}
        });
