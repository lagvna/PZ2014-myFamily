...
import com.myfamily.CalendarActivity;
...
public class EventViewActivity extends ListActivity implements OnTouchListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        myEvents = (ArrayList<MyEvent>) getIntent().getSerializableExtra("events");
            ...
            if (convertView == null) {
                ...
                switch (type) {
                    ...
                    case TYPE_SEPARATOR:
                        ...
                        ImageButton eventRemoveButton = (ImageButton) convertView.findViewById(R.id.eventRemoveButton);
